    ...
    <div class="px-4 -mt-16 pb-6">
        ...
        <div class="bg-white rounded-2xl card-shadow p-5 mb-4">
            ...
            @else
                ...
                <!-- Tombol Absen Cepat -->
                @if(!($statusHariIni['sudah_absen_pulang'] ?? false))
                <a href="{{ route('siswa.absensi.index') }}" class="block mt-4">
        ...
        <div class="grid grid-cols-3 gap-3 mb-4">
            <a href="{{ route('siswa.absensi.index') }}" class="bg-white rounded-xl card-shadow p-4 text-center hover:shadow-md transition-shadow">
            ...
            <a href="{{ route('siswa.izin.create') }}" class="bg-white rounded-xl card-shadow p-4 text-center hover:shadow-md transition-shadow">
            ...
            <a href="{{ route('siswa.riwayat.index') }}" class="bg-white rounded-xl card-shadow p-4 text-center hover:shadow-md transition-shadow">
        ...
        <div class="bg-white rounded-2xl card-shadow p-5">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ route('siswa.riwayat.index') }}" class="text-primary-600 text-sm font-medium">Lihat Detail →</a>
            </div>
