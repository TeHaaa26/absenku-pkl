...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4">
        <div class="flex flex-wrap items-end justify-between gap-4">
            <form method="GET" action="{{ route('guru.laporan.index') }}" class="flex flex-wrap gap-3">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Bulan</label>
                    <select name="bulan" class="px-4 py-2 border border-gray-200 rounded-lg focus:ring-primary-500 focus:border-primary-500">
                ...
                <div>
                    ...
                    <select name="tahun" class="px-4 py-2 border border-gray-200 rounded-lg focus:ring-primary-500 focus:border-primary-500">
                ...
                <div>
                    ...
                    <select name="lokasi_id" class="px-4 py-2 border border-gray-200 rounded-lg focus:ring-primary-500 focus:border-primary-500">
                        <option value="">Semua Lokasi</option>
                        @foreach($daftarLokasiOption as $lok)
            ...
            <div class="flex gap-2">
                {{-- Export Excel --}}
                <a href="{{ route('guru.laporan.export-excel', request()->all()) }}"
                ...
                {{-- Export PDF --}}
                <a href="{{ route('guru.laporan.export-pdf', request()->all()) }}"
